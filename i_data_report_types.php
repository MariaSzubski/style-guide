...
<head>
	<meta charset="utf-8">
	<title id="title">NX Guidelines - Iconography &ndash; Data &amp; Report Types</title>
	<link rel="stylesheet" href="css/build/style.css" charset="utf-8">
</head>
<body>
	<main class="default_state">
		<header>
			<h2 id="pg_header">Iconography &ndash; Data &amp; Report Types</h2>
		...
		<article id="guidelines">
			...
			<section class="desc full">
				...
				<section class="full">
					<h4></h4>
					<img src="img/guide/i_data-report-types.svg" alt="Iconography - Data &amp; Report Types">
				</section>
			</div>
		</article>
	</main>
