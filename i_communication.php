...
<head>
	<meta charset="utf-8">
	<title id="title">NX Guidelines - Iconography &ndash; Communication</title>
	...
	<main class="default_state">
		...
		<article id="guidelines">
			...
			<section class="desc full">
				<h4>Downloads</h4>
				<p class="guide_link">
					<a href="https://drive.google.com/open?id=0B4FYNrkqg7oDQjFobGJfNXN6UUk"><img src="img/download.svg" alt="Download">Communication Icons (zip)</a>
