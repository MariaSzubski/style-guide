		...
		<article id="guidelines">
			<div id="container">
				<section>
					...
					<img src="img/guide/p_card_horizontal_01.png" alt="Horizontal Card Layout - All Content Types">
				</section>
				<section>
					<h4>Card Examples</h4>
					<img src="img/guide/p_card_horizontal_02.png" alt="Horizontal Card Examples">
				</section>
				<aside>
					<dl class="related">
