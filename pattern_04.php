...
<head>
	...
	<title id="title">Style Guide &ndash; Patterns &ndash; Gravida Augue</title>
	<?php require 'template/css.inc.php'; ?>
</head>
<body>
	<main class="default_state">
		<header>
			<h2 id="pg_header"><span>Patterns &ndash; </span>Gravida Augue</h2>
				...
				<div class="spec_content">
					...
					<section class="full">
						...
						<section class="full">
							...
							<img src="img/guide/fpo_md_200.svg" alt="Nullam molestie auctor ">
							<!-- -->
							<h4>nisi pulvinar interdum</h4>
							<img src="img/guide/fpo_md_200.svg" alt="nisi pulvinar interdum">
						</section>
					</section>
